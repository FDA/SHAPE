...
import { isEmptyObject, publicParticipantQuery } from '../utils/Utils';
...
class NotificationCreatorPublic extends React.Component<NCProps, StateProps> {
    ...
    UNSAFE_componentWillMount = () => {
        let publicSurveys: Array<Survey> = [];
        this.setState({ isLoading: true });
        getSurveys().then((snapshot: any) => {
            snapshot.forEach((doc: any) => {
                let tempSurvey = doc.data;
                tempSurvey.id = doc.id;
                if (tempSurvey.public && tempSurvey.open) publicSurveys.push(tempSurvey);
            });

            this.setState({ publicSurveys: publicSurveys });
        ...
        return (
            <>
                ...
                <NotificationFilters
                    ...
                    setGender={setGender}
                    filterForRespondents={filterForPublicRespondents}
                    setAge={setAge}
                    clearFilters={publicClearFilters}
                />
                <br />
                <br />
                <IonHeader role='generic'>
...
export default withRouter(connect(mapStateToProps)(NotificationCreatorPublic));
