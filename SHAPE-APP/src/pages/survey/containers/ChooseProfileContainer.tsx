...
import { initializeQuestionnaire, setActiveProfile } from '../../../redux/actions/Questionnaire';
...
const mapDispatchToProps = (dispatch: any) => {
    return {
        ...
        initializeQuestionnaireDispatch(target: Target, participantResponse: Array<ParticipantResponse>) {
            dispatch(initializeQuestionnaire(target, participantResponse));
        }
    };
};

export default connect(mapStateToProps, mapDispatchToProps)(ChooseProfileContainer);
