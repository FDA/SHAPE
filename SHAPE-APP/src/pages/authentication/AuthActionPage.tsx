...
class AuthActionPage extends Component<PassedProps, AuthActionPageState> {
   ...
   urlParams = () => {
      ...
      const oobCode: string = !isEmptyObject(urlParams.get("oobCode"))
                     ...
                     <form onSubmit={(e) => this.handleSubmit(e, oobCode)}>
                        <IonItem>
                           ...
                           <p className="small-text">
                              Must contain 8 characters, at least 1 upper case
                              letter, and at least 1 special character or number
                           </p>
                           <IonInput
                              id="password-field"
