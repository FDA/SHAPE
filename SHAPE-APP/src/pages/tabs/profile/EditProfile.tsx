...
import { IonButton, IonFooter, IonInput, IonItem, IonLabel, IonToolbar } from '@ionic/react';
            ...
            <>
                <form id='editProfile' onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <IonFooter className='ion-no-border'>
                        <IonToolbar>
                            <IonButton id='cancel' expand='block' color='light' onClick={this.cancel}>
                                Cancel
                            </IonButton>
                            <IonButton type='submit' id='save-profile-button' expand='block' color='primary'>
                                Save
                            </IonButton>
                        </IonToolbar>
                    </IonFooter>
